...
public class PlayerControl : MonoBehaviour {
	...
	void CheckInput()
	{
		...
		desiredImpulseInput += (Input.GetKeyDown(KeyCode.LeftControl) ? 1000: 0) * impulseSensitivity * Time.deltaTime; //left control speed up spaceship
        desiredImpulseInput += (Input.GetKeyDown(KeyCode.LeftAlt) ? -1000 : 0) * impulseSensitivity * Time.deltaTime; //left alt speed down spaceship
